...
public class AllUses {
  ...
  @Test
  void test1() {
    double result = CalculateTips(7,20);

    Assertions.assertEquals(-1, result, 0.001);
  }
  @Test
  void test2() {
    double result = CalculateTips(10,4);
  ...
  @Test
  void test3() {
    double result = CalculateTips(20,4);
  ...
  @Test
  void test4() {
    double result = CalculateTips(16,-2);
  ...
  @Test
  void test5() {
    double result = CalculateTips(10,8);
  ...
  @Test
  void test6() {
    double result = CalculateTips(10,25);
  ...
  @Test
  void test7() {
    double result = CalculateTips(10,70);
  ...
  @Test
  void test8() {
    double result = CalculateTips(20,8);
  ...
  @Test
  void test9() {
    double result = CalculateTips(20,25);
  ...
  @Test
  void test10() {
    double result = CalculateTips(20,70);
